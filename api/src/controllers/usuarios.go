...
func BuscarUsuarios(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.RepositorioDeUsuarios(db)
	usuarios, erro := repositorio.Buscar(nomeOrNick)
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível deletar um usuário que não é o seu."))
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A senha atual é diferente"))
		return
	}
